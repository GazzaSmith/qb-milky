    ...
    while true do
		...
		local s1d = false
			if(GetDistanceBetweenCoords(coords, 2500.960, 4800.750, 34.740, true) < 3.0) then
				DrawText3Ds(2500.960, 4800.750, 34.740, '~y~[E] ~w~Pour milk into vat')
...
Citizen.CreateThread(function()
	...
	local s1d7 = false
	if dist <= 2.0 then
	DrawText3Ds(sellX, sellY, sellZ+0.1, "[E] Sell Milk bot")
